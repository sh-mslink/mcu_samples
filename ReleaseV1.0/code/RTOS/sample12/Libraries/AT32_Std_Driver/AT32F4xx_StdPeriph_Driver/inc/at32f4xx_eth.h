...
/** @defgroup PHY_Read_write_Timeouts 
  * @{
  */ 
#define PHY_READ_TO          ((uint32_t)0x0FFF) /*((uint32_t)0x000000FF) */
#define PHY_WRITE_TO         ((uint32_t)0x0FFF) /*((uint32_t)0x000000FF) */
...
/** @defgroup PHY_Reset_Delay 
  * @{
  */ 
#define PHY_ResetDelay                  ((uint32_t)0x000000FF) 
...
/** @defgroup PHY_Config_Delay 
  * @{
  */ 
#define PHY_ConfigDelay                 ((uint32_t)0x000000FF)
