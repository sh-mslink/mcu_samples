...
void TMR_TimeBaseStructInit(TMR_TimerBaseInitType* TMR_TimeBaseInitStruct)
{
  ...
  TMR_TimeBaseInitStruct->TMR_DIV = 0x0000;  //预分频不分频
  TMR_TimeBaseInitStruct->TMR_ClockDivision = TMR_CKD_DIV1;  //不分频
  TMR_TimeBaseInitStruct->TMR_CounterMode = TMR_CounterDIR_Up;  //自动加1
