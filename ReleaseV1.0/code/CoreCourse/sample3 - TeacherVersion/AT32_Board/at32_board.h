...
/*define I2C pin*/
#define I2C_SCL_PIN	  GPIO_Pins_8 // 定义实现I2C SCL功能的gpio号码
#define I2C_SDA_PIN	  GPIO_Pins_9 // 定义实现I2C SCL功能的gpio号码 
#define I2C_PORT     GPIOB        // 定义端口
#define I2C_GPIO_RCC_CLK   RCC_APB2PERIPH_GPIOB  //定义时钟
